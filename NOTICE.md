...
The Current Maintainer is **Imanol Felix Supo Mamani**.

The work consists of the files listed in [MANIFEST.txt](MANIFEST.txt), including
the package, documentation, examples, tests, and repository tooling. The compiled
guide and README preview are derived from the included TeX sources. Generated
compiler logs, local output archives, caches, and temporary files are not part of
the work. Archive MANIFEST.json is an additional generated integrity index.
